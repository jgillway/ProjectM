class Spawner {
    ...
    spawnChest() {
        ...
        const chest = new ChestModel(location[0], location[1], randomNumber(1, 20), this.id);
    ...
    spawnMonster() {
        const location = this.pickRandomLocation();
        const monster = new MonsterModel(location[0], location[1], randomNumber(1, 20), this.id, randomNumber(0, 20), randomNumber(3, 5), 1);
